 ...
 */
final class Version20231118142604 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE likes (id INT AUTO_INCREMENT NOT NULL, mot VARCHAR(255) NOT NULL, nblikes INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
